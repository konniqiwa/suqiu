...
import com.suqiu.user.feign.UserFeign;
...
public class OrderServiceImpl implements OrderService {
    ...
    public void add(Order order){
        ...
        System.out.println("创建订单的时间：" + date);
     ...
     */
    @Override
    public void updateStatus(String outtradeno, String paytime, String transaction_id) throws Exception{
