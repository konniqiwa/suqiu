package com.suqiu.user.controller;

import com.suqiu.user.pojo.Address;
import com.suqiu.user.service.AddressService;
...
public class AddressController {
    ...
    public Result<List<Address>> list() {
        ...
        return new Result<List<Address>>(true,StatusCode.OK,"查询用户收件地址列表成功！",list);
    }
