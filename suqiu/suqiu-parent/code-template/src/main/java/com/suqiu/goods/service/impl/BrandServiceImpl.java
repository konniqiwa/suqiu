...
public class BrandServiceImpl implements BrandService {
    ...
    public Example createExample(Brand brand){
        ...
        if(brand!=null){
            ...
            // 是否品牌制造商
            if(!StringUtils.isEmpty(brand.getFactoryStatus())){
                    criteria.andEqualTo("factoryStatus",brand.getFactoryStatus());
            }
            // 是否显示
            if(!StringUtils.isEmpty(brand.getShowStatus())){
                    criteria.andEqualTo("showStatus",brand.getShowStatus());
            }
        }
        return example;
    }
